...
export default function Projects({}: Props) {
    return (
        <div className="h-screen relative flex flex-col text-left md:flex-row m-w-full justify-evenly mx-auto items-center z-0 overflow-hidden">
            <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">Projects</h3>

            <div className="relative w-full flex z-20 overflow-x-scroll overflow-y-hidden snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#fb3131]/80 ">
                {projectList.map((e, i) => (
                    <div
                        key={e.link}
