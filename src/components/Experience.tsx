...
const experienceList = [
    {
        ...
        skills: [html, css, ts, react, next, tailwind],
        start: '2022.03',
        end: '',
        role: [
...
export default function Experience({}: Props) {
    return (
        ...
        >
            ...
            <div className="w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory mt-[10rem]">
                {experienceList.map((e) => (
                    <ExperienceCard key={e.company} experienceData={e} />
                ))}
            </div>
        </motion.div>
    );
